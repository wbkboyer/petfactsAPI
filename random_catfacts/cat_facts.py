...
def get_all_catfacts(proxies={"http": "", "https": ""}):
...
def try_querying_catfacts(limit=500, proxies={"http": "", "https": ""}):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--filename", type=str, help="Full path to file containing catfacts, one per newline.")
    parser.add_argument("-w", "--webhook", type=str, help="Link to slack webhook.")
